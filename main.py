...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        title_lbl=Label(bg_img,text="نظام تسجيل الحضور باكاديمية الشروق",font=("times new roman",35,"bold"),bg="white",fg="red")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        #student button 
        img4=Image.open(r"C:\Users\DELL\Desktop\face recognition system\images\student.jpeg")
        ...
        #Detect face button 
        img5=Image.open(r"C:\Users\DELL\Desktop\face recognition system\images\student.jpeg")
        img5=img5.resize((100,70),Image.ANTIALIAS)
        ...
        b1_1.place(x=500,y=260,width=200,height=40)
         ...
         #Detect face button 
        img6=Image.open(r"C:\Users\DELL\Desktop\face recognition system\images\student.jpeg")
        ...
        #ss button 
        img7=Image.open(r"C:\Users\DELL\Desktop\face recognition system\images\student.jpeg")
        ...
        #ss button 
        img8=Image.open(r"C:\Users\DELL\Desktop\face recognition system\images\student.jpeg")
        ...
        b1_1.place(x=500,y=480,width=200,height=40)
         ...
         #ss button 
        img9=Image.open(r"C:\Users\DELL\Desktop\face recognition system\images\student.jpeg")
